...
The project aims to recreate the core behavior of the standard C memory management APIs:
...
* **Page Header**
  ...
  * Stores pointer of a first block.
* **Memory Region**
...
Every page maintains its own doubly linked list of memory blocks.
...
2. Normalize the requested size to the allocator's alignment.
3. Search for a suitable free block using the **First-Fit** strategy.
